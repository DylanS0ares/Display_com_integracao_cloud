...
DRIVE_DIRECTORY_ID = "### adicione aqui seu ID diretório " # Tirei o anterior para não entrarem no meu drive xD , note que mesmo com o ID é necessário a ativação com o GoogleAuth
